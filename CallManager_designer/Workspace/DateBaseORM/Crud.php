...
class Crud {
    ...
    public function Get($p) {
        ...
        // Генерируем уникальный ключ для кеша на основе запроса
        //$cacheKey = md5($query);

        // Проверяем, есть ли результат в кеше
        //$cachedResult = $this->memcache->get($cacheKey);

//        if ($cachedResult !== false) {
//            //var_dump('Кэш '.$cachedResult);
...
//                exit();
       ...
       // var_dump($data);
        ...
        $result->free();
//var_dump($data);
//        // Сохраняем результат в кеш с уникальным ключом
//$this->memcache->set($cacheKey, $data, MEMCACHE_COMPRESSED, $expirationTime);
